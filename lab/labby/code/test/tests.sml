...
struct
  ...
  fun runTests(cmd : string, args : string list) : int =
    (
      testEq("dup [1, 2, 3]", [1, 1, 2, 2, 3, 3], Lab2.dup([1, 2, 3])) ;

      testEq("length [5, 4, 3, 2]", 4, Lab2.length ([5, 4, 3, 2])) ;

      testEq("sum [2, 4]", 6, Lab2.sum ([2, 4])) ;

      testEq("max [7, ~2, 4]", 7, Lab2.max([7, ~2, 4])) ;

      testEq("max [~2, 4, 7]", 7, Lab2.max ([~2, 4, 7]));

      testEq("dupPattern [1, 2, 3]", [1, 1, 2, 2, 3, 3], Lab2.dupPattern([1, 2, 3])) ;

      testEq("lengthPattern [5, 4, 3, 2]", 4, Lab2.lengthPattern ([5, 4, 3, 2])) ;

      testEq("sumPattern [2, 4]", 6, Lab2.sumPattern ([2, 4])) ;

      testEq("maxPattern [7, ~2, 4]", 7, Lab2.maxPattern([7, ~2, 4])) ;
